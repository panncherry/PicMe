...
**PicMe** is a photo sharing app using Parse as its backend.
...
1. User profile photo and user name is displaying for each post in the feed. However, I am having difficult time to fetch the posted image.
2.
...
<img src='https://i.imgur.com/5zlAFWE.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
